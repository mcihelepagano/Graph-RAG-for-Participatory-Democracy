...
\usepackage[a4paper, left=2.54cm, right=2.54cm, top=2.54cm, bottom=2.54cm, bindingoffset=1.9cm]{geometry}
...
\usepackage[final, nopatch=footnote]{microtype} % microtypography, final lets latex use it also in bibliography
